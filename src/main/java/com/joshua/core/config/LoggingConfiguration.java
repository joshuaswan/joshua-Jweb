...
import com.joshua.core.config.builder.OptionalBuilder;
import com.joshua.core.config.util.LogLevel;
import com.joshua.core.config.util.Size;
...
public class LoggingConfiguration {
    ...
    public static class FileConfiguration {
        ...
        @NotNull
        private Optional<ArchiveConfiguration> archive = absent();
    ...
    @NotNull
    private Optional<ConsoleConfiguration> console = absent();

    @NotNull
    private Optional<FileConfiguration> file = absent();
    ...
    public static class LoggingConfigurationBuilder implements Builder<LoggingConfiguration> {
        ...
        public class FileConfigurationBuilder implements Builder<FileConfiguration> {
            ...
            public class ArchiveConfigurationBuilder implements Builder<FileConfiguration.ArchiveConfiguration> {
                ...
                public ArchiveConfigurationBuilder cleanHistoryOnStart(boolean cleanHistoryOnStart) {
                    this.cleanHistoryOnStart = cleanHistoryOnStart;
                    return this;
                }

                public FileConfiguration.ArchiveConfiguration build() {
                    return new FileConfiguration.ArchiveConfiguration(namePattern, maxHistory, maxFileSize, cleanHistoryOnStart);
                }
