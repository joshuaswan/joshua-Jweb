...
import static com.joshua.core.config.util.LogLevel.*;
import static com.joshua.core.core.internal.logging.Logging.configure;
...
public class LoggingTest {
    ...
    private final static LogTestContext CONSOLE = new LogTestContext() {
        ...
        public LoggingConfiguration configLogger() {
            return Configuration.config().logging().level(OFF)
