...
import com.heren.core.core.servlet3.AutoScan;
import com.heren.core.core.servlet3.Specified;
...
public class Servlet3FacetTest {
    ...
    public static String get(String url) throws Exception {
        ...
        client.start();
        try {
            return new String(client.GET(url).getContentAsString());
        } finally {
            client.stop();
        }
    }
    ...
    public static int status(String url) throws Exception {
        ...
        client.start();
        try {
            return client.GET(url).getStatus();
        } finally {
            client.stop();
        }
    }
