...
import static com.heren.core.config.util.LogLevel.*;
import static com.heren.core.core.internal.logging.Logging.configure;
...
public class LoggingTest {
    ...
    private final static LogTestContext CONSOLE = new LogTestContext() {
        ...
        public LoggingConfiguration config(LogLevel level) {
            return Configuration.config().logging().level(level)
                    .console().format("%m\n")
                    .end().build();
        }
        ...
        public LoggingConfiguration configLogger() {
            return Configuration.config().logging().level(LogLevel.OFF)
