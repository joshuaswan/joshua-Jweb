...
import static com.heren.core.config.HttpConfiguration.*;
import static com.heren.core.config.util.Duration.Unit.MILLISECONDS;
import static com.heren.core.config.util.Duration.Unit.SECONDS;
