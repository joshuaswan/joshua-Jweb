...
import com.heren.core.container.grizzly.internal.tryus.TyrusWebsocketServerContainer;
import com.heren.core.core.ApplicationModule;
import com.heren.core.core.ContainerConfigurator;
...
import static com.heren.core.core.internal.util.TypePredicates.isPresent;
...
//            });
            ...
            GuiceInjector.setInjector(container.injector());

            TyrusWebsocketServerContainer tyrusWebsocketServerContainer = new TyrusWebsocketServerContainer(container,
                    module.path(), endpoints, GuiceInjector.getInjector(), null, module.configuration().getHttp().getPort());
