 ...
 */
public final class HerenJpaPersistModule extends PersistModule {
  private final String jpaUnit;

  public HerenJpaPersistModule(String jpaUnit) {
  ...
  @Override protected void configurePersistence() {
    ...
    bind(HerenJpaPersistService.class).in(Singleton.class);

    bind(PersistService.class).to(HerenJpaPersistService.class);
    bind(UnitOfWork.class).to(HerenJpaPersistService.class);
    bind(EntityManager.class).toProvider(HerenJpaPersistService.class);
    bind(EntityManagerFactory.class)
        .toProvider(HerenJpaPersistService.EntityManagerFactoryProvider.class);

    transactionInterceptor = new HerenJpaLocalTxnInterceptor();
  ...
  @Provides @Jpa String[] providePackages() {
    return packages;
  }
   ...
   */
  public HerenJpaPersistModule properties(Map<?,?> properties) {
    this.properties = properties;
    return this;
  }

  public HerenJpaPersistModule packages(String... packages) {
   ...
   */
  public <T> HerenJpaPersistModule addFinder(Class<T> iface) {
