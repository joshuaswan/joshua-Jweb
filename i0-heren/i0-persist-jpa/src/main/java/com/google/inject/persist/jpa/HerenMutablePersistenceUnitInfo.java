 ...
 * @since 2.0
 */
public class HerenMutablePersistenceUnitInfo implements HerenSmartPersistenceUnitInfo {
	...
	public ClassLoader getClassLoader() {
		...
		if (cl == null) {
			...
			cl = HerenMutablePersistenceUnitInfo.class.getClassLoader();
			if (cl == null) {
	...
	public ClassLoader getNewTempClassLoader() {
		return this.getClassLoader();// FIXME: 2016/10/21
